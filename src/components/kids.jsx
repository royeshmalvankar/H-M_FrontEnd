...
const Kids = () => {
    ...
    const getkids = async () => {
        setLoding(true)
        try {
            const response = await axios.get("https://h-m-backend.onrender.com/product/search?Category=Kids", {
                headers: {
    ...
    return (
        <>
        <h1 style={{textAlign:"center",fontSize:"30px",fontWeight:"bold"}}>Kids</h1>
        <div className="cards">
