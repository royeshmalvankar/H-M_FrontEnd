...
const Baby  = () => {
    ...
    const getbaby = async () => {
        setLoding(true)
        try {
            const response = await axios.get("https://h-m-backend.onrender.com/product/search?Category=Baby", {
                headers: {
    ...
    return (
        <>
        <h1 style={{textAlign:"center",fontSize:"30px",fontWeight:"bold"}}>Baby</h1>
        <div className="cards">
